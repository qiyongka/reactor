# -*- coding: utf-8 -*-
"""
将每个点和均值之间的距离计算出来,附加在行末尾,并且计算得到的最前面的domin个点
...
for folder in range(len(foldernames)):
    ...
    output_path = '/home/qyk/Desktop/电抗器/demo3/similar/distance'

    mkdir(output_path)
    input_file = input_path +'/'+ foldernames[folder]+'_fft_point.csv' #输入fft后的结果
    output_file = output_path +'/' +foldernames[folder]+'fft_distance.csv'  #输出基频和倍频的增益
